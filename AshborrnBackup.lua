...
if AshExecutor == nil then -- if you want to directly execute the script
    AshExecutor = "Unsupported" -- Supported / Unsupported
    AshDevice = "PC" -- Mobile / PC
end
...
function ExecutorFunction()
    if AshExecutor == "Unsupported" then
