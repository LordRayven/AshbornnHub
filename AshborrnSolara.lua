    ...
    Tabs.Combat:AddButton({
        ...
        Callback = function()
            ...
            -- Function to check if the player is alive (assuming IsAlive function is defined)
            local function IsAlive(player)
                -- Define your logic to check if the player is alive
                return true -- Replace with your actual logic
            end
            
            -- Function to send notification (assuming SendNotif function is defined)
            local function SendNotif(title, message, duration)
                -- Define your notification sending logic
                print(title .. ": " .. message) -- Replace with your actual notification logic
            end
