...
local objects = {}
local themes = {
    Background = Color3.fromRGB(75, 0, 130),     -- A deep indigo purple
    Glow = Color3.fromRGB(138, 43, 226),         -- Blue violet
    Accent = Color3.fromRGB(148, 0, 211),        -- Dark violet
    LightContrast = Color3.fromRGB(153, 50, 204),-- Dark orchid
    DarkContrast = Color3.fromRGB(72, 61, 139),  -- Dark slate blue
